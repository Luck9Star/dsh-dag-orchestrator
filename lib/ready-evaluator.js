 ...
 * narrowed). The two `dependency_gate_*` codes are M3 placeholders: the gate
 * seam is trimmed in M1 (see narrowing manifest #1) but the codes are
 * exported now so T18's regression keeps a stable vocabulary.
 */
